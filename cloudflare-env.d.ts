/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: a0ecfcf01e8f053968eed9d7d93bc1bd)
...
interface __BaseEnv_CloudflareEnv {
	...
	ADMIN_EMAIL: "cadenjsumner@gmail.com";
	UPVOTE_HASH_SECRET: string;
	SEQUENZY_API_KEY: string;
	SEQUENZY_CAMPAIGNS_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "ADMIN_EMAIL" | "UPVOTE_HASH_SECRET" | "SEQUENZY_API_KEY" | "SEQUENZY_CAMPAIGNS_API_KEY">> {}
}
