      ...
      <div className="glass-panel" style={{ padding: '4rem', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <nav aria-label="On this page" style={{ marginBottom: '2.5rem', padding: '1.25rem 1.5rem', border: '1px solid var(--border-color)', borderRadius: '12px' }}>
          ...
          <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', paddingLeft: '1.25rem', margin: 0, fontSize: '0.9rem' }}>
            ...
            <li><a href="#find-config">Step 1: Find your client&rsquo;s configuration</a></li>
            <li><a href="#local-server">Step 2: Add a local (stdio) server</a></li>
            <li><a href="#remote-server">Step 3: Add a remote (hosted) server</a></li>
            <li><a href="#common-setups">Common setups</a></li>
            <li><a href="#security">Security best practices</a></li>
            <li><a href="#troubleshooting">Troubleshooting</a></li>
            <li><a href="#advanced">Advanced: combining multiple servers</a></li>
