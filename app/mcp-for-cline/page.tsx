    ...
    '@graph': [
      {
        ...
        description:
          'Guide to configuring Model Context Protocol (MCP) servers in Cline and VS Code.',
        url: 'https://allmcps.com/mcp-for-cline',
      },
      {
        '@type': 'FAQPage',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Cline / VS Code',
            item: 'https://allmcps.com/mcp-for-cline',
          },
        ],
      },
    ],
      ...
      >
        ...
        <section style={{ maxWidth: '800px', marginBottom: '3rem' }}>
          <Badge variant="verified" style={{ marginBottom: '1rem' }}>
            Cline / VS Code Directory & Generator
          </Badge>
          <h1 className="text-display" style={{ marginBottom: '1rem' }}>
            Top MCP Servers for{' '}
            <span className="text-brand-gradient">Cline / VS Code</span>
          </h1>
          <p className="text-lead" style={{ marginBottom: '1.5rem' }}>
            Connect Cline in VS Code directly to databases, web search, GitHub
            repositories, and system tools using Model Context Protocol.
          </p>
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            <Link href="#top-servers" className="btn btn-primary">
              Browse Cline MCP Servers
            </Link>
            <Link
              href="/clients/cline"
