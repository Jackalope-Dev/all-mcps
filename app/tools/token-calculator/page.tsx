...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Estimate the context-window cost of your installed MCP servers’ tool schemas.',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://allmcps.com/tools/token-calculator',
    },
  ],
};
      ...
      <div className="page-shell-inner">
        ...
        <div className="surface page-panel">
          ...
          <p className="text-lead" style={{ marginBottom: '2rem' }}>
            Every MCP server you connect sends its tool definitions to the model
            on every turn. Estimate how much of your context window that&apos;s
          ...
          >
            ...
            <p style={{ marginBottom: '1.25rem' }}>
              When an MCP client connects to a server, it asks for that
              server&apos;s list of tools &mdash; each with a name, a
              description, and a JSON Schema describing its parameters &mdash;
              and includes all of that in every request sent to the model,
              whether or not the model ends up calling any of those tools that
              turn. Connect enough servers, especially ones with many tools or
              verbose parameter schemas, and you can burn a meaningful slice of
              your context window before you&apos;ve typed a single message.
            </p>
