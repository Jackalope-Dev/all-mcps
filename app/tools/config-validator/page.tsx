...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://allmcps.com/tools/config-validator',
    },
  ],
};
      ...
      <div className="page-shell-inner">
        ...
        <div className="surface page-panel">
          ...
          <p className="text-lead" style={{ marginBottom: '2rem' }}>
            Paste your <code>mcpServers</code> (or VS Code <code>servers</code>)
            JSON below to catch mistakes before your AI client silently fails to
            load a server.
          </p>
          ...
          >
            ...
            <p style={{ marginBottom: '1.25rem' }}>
              A single misplaced comma or a missing <code>command</code> field
              is enough to make an MCP client quietly skip a server on startup,
              usually with no error message pointing at the actual cause.
              Tracking that down by trial and error &mdash; edit, save, fully
              restart the client, check if it worked &mdash; is slow.
            </p>
            ...
            <FaqSection
              ...
              items={[
                ...
                },
                {
                  ...
                  answer: (
                    <>
                      Environment variables are specified under the{' '}
                      <code>env</code> object as key-value string pairs, for
                      example:{' '}
                      <code>
                        &quot;env&quot;: &#123; &quot;API_KEY&quot;:
                        &quot;secret_123&quot; &#125;
                ...
                },
                {
                  ...
                  answer: (
                    <>
                      In JSON, backslashes must be escaped with double
                      backslashes (e.g.,{' '}
                      <code>
                        &quot;C:\\\\Program Files\\\\node\\\\node.exe&quot;
                      </code>
                      ) or replaced with forward slashes (
                      <code>&quot;C:/Program Files/node/node.exe&quot;</code>).
                    </>
                  ),
                },
                {
