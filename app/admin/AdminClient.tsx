                    ...
                    {hasExtra && (
                      ...
                      >
                        ...
                        >
                          ...
                          {server.authType && (
                            <div>Auth: {server.authType}</div>
                          )}
                          {server.license && (
                            <div>License: {server.license}</div>
                          )}
                          {server.maintenanceStatus && (
                            <div>Maintenance: {server.maintenanceStatus}</div>
                          )}
                          {clientsList.length > 0 && (
                            <div>
                              Compatible clients: {clientsList.join(', ')}
                            </div>
                          )}
                          {server.supportUrl && (
                            <div>Support: {server.supportUrl}</div>
                          )}
