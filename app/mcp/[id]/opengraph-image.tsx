 ...
 */
function resolveListingLogoSrc(
  server: OgServer | null | undefined,
): string | null {
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        padding: '48px',
        background:
          'linear-gradient(135deg, #030712 0%, #080f24 40%, #0d1936 80%, #030712 100%)',
        position: 'relative',
    ...
    >
      ...
      <div
        style={{
          ...
          height: '650px',
          background:
            'radial-gradient(circle, rgba(0, 229, 255, 0.22) 0%, rgba(0, 123, 255, 0.06) 45%, transparent 70%)',
          display: 'flex',
        }}
      />
      <div
        style={{
          ...
          height: '650px',
          background:
            'radial-gradient(circle, rgba(0, 123, 255, 0.20) 0%, rgba(99, 102, 241, 0.05) 50%, transparent 75%)',
          display: 'flex',
        }}
      />
      ...
      >
        ...
        <rect width="1200" height="630" fill="url(#grid-pattern-mcp)" />
      </svg>
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            <span
              style={{ fontSize: '18px', color: '#94A3B8', fontWeight: 600 }}
            >
              📦 Verified Model Context Protocol Integration
            </span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span
              style={{ fontSize: '18px', color: '#00E5FF', fontWeight: 700 }}
            >
              Install on AllMCPs.com
            </span>
          </div>
        </div>
      </div>
      ...
      <div
        style={{
          ...
          height: '8px',
          background:
            'linear-gradient(90deg, #00E5FF 0%, #007BFF 50%, #6366F1 100%)',
          display: 'flex',
        }}
      />
    </div>,
