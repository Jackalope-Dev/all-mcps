...
export default async function Image({ params }: { params: Promise<{ id: string }> | { id: string } }) {
  ...
  const displayTitleRaw = cleanTitle.charAt(0).toUpperCase() + cleanTitle.slice(1);
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <defs>
            <pattern id="grid-pattern-mcp" width="40" height="40" patternUnits="userSpaceOnUse">
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <svg width="56" height="56" viewBox="0 0 1024 1024" style={{ marginRight: '18px' }}>
                <defs>
                  <linearGradient id="cyanGradMcp" x1="0%" y1="0%" x2="100%" y2="100%">
