                    ...
                    {typeof server.githubStars === 'number' &&
                      server.githubStars > 0 && (
                        ...
                        >
                          ...
                          <span className="mcp-icon-tooltip-body">
                            Total stargazers on GitHub for the source repository
                            ({server.githubStars.toLocaleString()} stars).
                          </span>
                        </IconTooltip>
                      )}
                  </OutboundLink>
                    ...
                    {readme ? (
                      (() => {
                        ...
                        const { excerpt, truncated } =
                          truncateReadmeExcerpt(readme);
                        return (
                          <>
                            <SafeMarkdown
                              content={excerpt ?? readme}
                            ...
                            {truncated && (
                              <p style={{ marginTop: '1.25rem' }}>
                                ...
                                >
                                  ...
                                  {repoHost || 'the source repository'} →
                                </OutboundLink>
                              </p>
                            )}
                          </>
                      ...
                      <>
                        ...
                        {!hasSuppliedDescription && (
                          <p>
                            ...
                            summary above comes from its listing details. To
                            install it, use the one-click buttons or copy the
                            config from the{' '}
                            <a href="#quick-install">Quick Install</a> section
                            above, then open the{' '}
                            <OutboundLink
                              href={server.url}
                              destinationType="github"
                      ...
                      >
                        {(() => {
                          ...
                          if (
                            ...
                            return 'Python';
                          if (cmd.includes('docker') || desc.includes('docker'))
                            return 'Docker';
                          if (cmd.includes('go') || desc.includes('golang'))
                            return 'Go';
                          return 'Node.js';
                        })()}
                      </span>
