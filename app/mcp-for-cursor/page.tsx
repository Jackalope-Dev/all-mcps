    ...
    '@graph': [
      {
        ...
        description:
          'Guide to configuring Model Context Protocol (MCP) servers in Cursor AI editor.',
        url: 'https://allmcps.com/mcp-for-cursor',
      },
      {
        '@type': 'FAQPage',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Cursor IDE',
            item: 'https://allmcps.com/mcp-for-cursor',
          },
        ],
      },
    ],
      ...
      >
        ...
        <section style={{ maxWidth: '800px', marginBottom: '3rem' }}>
          ...
          <h1 className="text-display" style={{ marginBottom: '1rem' }}>
            ...
            <span className="text-brand-gradient">Cursor IDE</span>
          </h1>
          <p className="text-lead" style={{ marginBottom: '1.5rem' }}>
            Connect Cursor Composer and AI agents directly to local databases,
            file systems, GitHub repositories, and external APIs using Model
            Context Protocol (MCP).
          </p>
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            <Link href="#top-servers" className="btn btn-primary">
              Top Cursor MCP Servers
            </Link>
            <Link
              href="/clients/cursor"
        ...
        <section id="top-servers" style={{ marginBottom: '4rem' }}>
          ...
          >
            <Sparkles size={20} style={{ color: 'var(--accent-color)' }} /> Top
            Compatible MCP Servers for Cursor
          </h2>
          <ul
            style={{
              listStyle: 'none',
