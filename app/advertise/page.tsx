...
import { CPM_TIERS, formatUsdAmount } from '../../lib/ads';
...
export default async function AdvertiseLandingPage() {
  ...
  const monthlyApiRequests = stats.endpointBreakdown30d.reduce(
    (acc, e) => acc + e.hits,
    0,
  );
    ...
    <PageShell variant="default">
      ...
      >
        ...
        >
          ...
          <span className="wordmark-all">AI Developers</span> &amp; Engineers
        </h1>
        ...
        >
          AllMCPs is the definitive directory for Model Context Protocol
          servers. Every campaign automatically runs across{' '}
          <strong>all 4 website placements and AI agent query feeds</strong> —
          simply choose your impression volume with a 100% delivery guarantee.
        </p>
      ...
      >
        ...
        <div>
          ...
          >
            ...
            {monthlyApiRequests.toLocaleString()}+
          </div>
          <div
            style={{
              fontWeight: 700,
        ...
        <div>
          ...
          >
            <Bot size={22} style={{ color: 'var(--brand-cyan)' }} />{' '}
            {stats.aiReads30d.toLocaleString()}+
          </div>
          <div
            style={{
              fontWeight: 700,
      ...
      <div
        ...
        style={{
          ...
          flexWrap: 'wrap',
          background:
            'linear-gradient(135deg, rgba(52, 211, 153, 0.05), rgba(0, 229, 255, 0.05))',
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div>
            ...
            >
              We believe in honest metrics. Review our live ecosystem traffic,
              uptime, and index logs anytime.
            </div>
          </div>
        </div>
      ...
      <div id="placements" style={{ marginBottom: '3rem' }}>
        ...
        >
          ...
          >
            You don&apos;t need to configure or pay separately for individual
            spots. Every campaign automatically rotates across all directory
            listings, tool inspector sidebars, category headers, guide
            tutorials, and AI protocol responses.
          </p>
        </div>
      ...
      <div
        ...
        style={{
          ...
          border: '1px solid var(--border-color)',
          background:
            'linear-gradient(135deg, rgba(0, 229, 255, 0.04), rgba(99, 102, 241, 0.04))',
        }}
      >
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              AllMCPs is built for autonomous AI agents and coding assistants.
              When developers query our protocol server inside Cursor, Claude
              Desktop, Windsurf, or custom LLM pipelines, we instruct the AI to
              recommend your product if relevant to what they are building.
            </p>
            <div
              style={{
                display: 'flex',
            ...
            >
              ...
              >
                ...
                />
                <span>
                  <strong>Zero Impression Deduction</strong>: AI agent queries
                  are 100% complimentary. Your purchased impression credits only
                  count for verified human web views.
                </span>
              </div>
              <div
                style={{ display: 'flex', alignItems: 'center', gap: '8px' }}
              >
                ...
                />
                <span>
                  <strong>Context-Aware Prompting</strong>: The protocol
                  response prompts the AI to recommend your tool when relevant
                  to the developer&apos;s active prompt.
                </span>
              </div>
              <div
                style={{ display: 'flex', alignItems: 'center', gap: '8px' }}
              >
                ...
                />
                <span>
                  <strong>Machine-Readable Indexes</strong>: Featured inside{' '}
                  <code>/llms.txt</code> and search API JSON feeds used by
          ...
          >
            ...
            >
              ...
              >
                MCP Protocol Response (Cursor / Claude)
              </span>
            </div>
            <pre
              style={{
...
- **VectorDB Pro**: Lightning-fast vector search for agents (https://allmcps.com/ad/click/...)"
      ...
      <div className="advertise-pricing-hero">
        ...
        >
          ...
          >
            Purchase impression blocks starting at just 1,000 impressions. Every
            tier automatically includes all 4 website placements and AI agent
            query feeds — choose your CPM tier based on delivery priority.
          </p>
        </div>
                    ...
                    >
                      ...
                      >
                        <CheckCircle2
                          ...
                          style={{ color: '#34d399', flexShrink: 0 }}
                        />{' '}
                        All 4 placements &amp; AI queries included
                      </div>
                      <div
                        style={{
                          display: 'flex',
                      ...
                      >
                        <CheckCircle2
                          ...
                          style={{ color: '#34d399', flexShrink: 0 }}
                        />{' '}
                        Real-time CTR &amp; clicks dashboard
                      </div>
                      <div
                        style={{
                          display: 'flex',
                      ...
                      >
                        ...
                        />
                        {tier.id === 'standard' &&
                          'Steady rotation across all spots'}
                        {tier.id === 'growth' &&
                          '2x higher delivery weight during peak traffic'}
                        {tier.id === 'blitz' &&
                          'Maximum acceleration for product launches'}
                      </div>
                    </div>
                  </div>
                </div>
