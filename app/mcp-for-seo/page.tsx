...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'MCP for SEO & AEO', item: 'https://allmcps.com/mcp-for-seo' },
  ],
};
...
const tocItems: TocItem[] = [
  ...
  { id: 'aeo-geo-readiness', text: 'AEO & GEO (AI answer engine optimization)' },
  { id: 'serp-intelligence', text: 'Live SERP intelligence & competitive research' },
...
const featuredSeoServers = [
  {
    ...
    description: 'Unified MCP server integrating Google Search Console, GA4, Bing Webmaster Tools, and Microsoft Clarity with built-in analytical routines.',
  ...
  },
  {
    ...
    description: 'Search Console automation for agents: inspect URL index status, uncover unindexed sitemap URLs, pull striking distance keywords, and request indexing.',
  ...
  },
  {
    ...
    description: 'Specialized agent tools for Answer Engine Optimization: verify crawler permissions (GPTBot, ClaudeBot), test llms.txt, and audit Schema.org JSON-LD.',
  ...
  },
  {
    ...
    description: 'Fast, ephemeral technical site auditing with 50+ automated checks: status codes, redirect loops, canonical links, robots.txt, and WAF detection.',
  ...
  },
  {
    ...
    description: 'Comprehensive SEO tool suite spanning Search Console, GA4, PageSpeed Insights, Cloudflare, CrUX Core Web Vitals, and IndexNow.',
  ...
  },
  {
    ...
    description: 'Zero-configuration SEO and GEO engine checker with 21 technical and generative engine checks for live websites.',
    category: 'Marketing',
  ...
  },
  {
    ...
    name: 'Climbpast',
    badge: 'Analytics & GTM',
    description: 'Read and edit Google Analytics 4, Search Console, and Google Tag Manager across 29 specialized MCP tools.',
  ...
  },
  {
    ...
    description: 'Curated SISTRIX tools: domain visibility indexes, keyword rankings, backlink analysis, and AI visibility metrics.',
    category: 'Marketing',
        ...
        <div className="lg:grid lg:grid-cols-[1fr_260px] lg:gap-10">
          <div className="surface page-panel min-w-0">
            <nav aria-label="Breadcrumb" style={{ fontSize: '0.85rem', marginBottom: '0.75rem' }}>
              ...
              <span style={{ color: 'var(--text-primary)' }}>MCP for SEO &amp; AEO</span>
            </nav>
            ...
            <div className="markdown-body">
              <h2 id="why-mcp-for-seo">Why MCP changes SEO, AEO, and Webmaster operations</h2>
              <p>
              ...
              <p>
                The <strong>Model Context Protocol (MCP)</strong> turns this multi-step manual chore into a unified, agentic execution pipeline. By connecting an MCP client (such as Claude Desktop, Claude Code, Cursor IDE, Windsurf, or custom agent runtimes) to specialized SEO servers, your agent can:
              </p>
              <ul>
                <li><strong>Read real-time search performance data</strong> directly from Google Search Console, Bing Webmaster, and GA4 APIs without exporting CSV files.</li>
                <li><strong>Run live, ephemeral technical audits</strong> checking status codes, redirect chains, canonical tags, hreflang annotations, and schema markup before and after code deploys.</li>
                <li><strong>Automate instant indexing signals</strong> by dispatching IndexNow payloads and GSC inspection requests as part of your CI/CD or content publishing build scripts.</li>
                <li><strong>Optimize for Answer Engine Optimization (AEO) and Generative Engine Optimization (GEO)</strong> &mdash; ensuring your <code>llms.txt</code>, structured schema, and entity relationships are primed for Perplexity, ChatGPT Search, Claude, and Google AI Overviews.</li>
              </ul>

              <h2 id="gsc-automation">Google Search Console (GSC) automation via MCP</h2>
              <p>
                Google Search Console is the authoritative ground truth for organic search performance on Google. With MCP servers like <Link href="/mcp/gsc-indexer-mcp"><strong>gsc-indexer-mcp</strong></Link>, <Link href="/mcp/seo-stack-mcp"><strong>seo-stack-mcp</strong></Link>, and <Link href="/mcp/climbpast"><strong>climbpast</strong></Link>, agents can query Search Console data programmatically.
              </p>

              <h3>1. Programmatic URL Inspection &amp; Index Status</h3>
              <p>
                Instead of pasting URLs one by one into the Search Console web interface, an MCP-connected agent can iterate through your entire XML sitemap, execute the <code>inspect_url</code> tool, and report:
              </p>
              <ul>
                <li>Index coverage state (<code>INDEXED</code>, <code>DISCOVERED_NOT_INDEXED</code>, <code>CRAWLED_NOT_INDEXED</code>).</li>
                <li>Last crawl timestamp and crawler agent (Googlebot Desktop vs. Smartphone).</li>
                <li>Canonical declaration mismatches (User-declared canonical vs. Google-selected canonical).</li>
                <li>Mobile usability and rich result qualification.</li>
              </ul>

              <h3>2. Identifying &ldquo;Striking Distance&rdquo; Ranking Opportunities</h3>
              <p>
                A high-ROI SEO workflow for agents is discovering queries ranking in positions <strong>4 through 15</strong> with high impressions but low click-through rates (CTR). An agent with GSC MCP tools can pull query performance grouped by URL, calculate the CTR curve gap, read the target page&rsquo;s markdown or source code, and directly generate title tag improvements, section expansions, and FAQ additions to push rankings onto the podium.
              </p>

              <h2 id="bing-indexnow">Bing Webmaster Tools &amp; IndexNow instant push</h2>
              <p>
                While Google remains dominant for traditional organic queries, Microsoft Bing powers Bing Search, Windows Copilot, and significant portions of AI-assistant citations. The <strong>IndexNow</strong> protocol enables webmasters to instantly notify Bing, Yandex, Seznam, and Naver whenever URLs are created, modified, or deleted.
              </p>

              <div className="surface" style={{ padding: '1.25rem', borderRadius: '12px', borderLeft: '4px solid var(--accent-color)', marginBottom: '1.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 700, marginBottom: '0.35rem', color: 'var(--text-primary)' }}>
                  <Zap size={18} style={{ color: 'var(--accent-color)' }} /> Why IndexNow matters for AI discovery
                </div>
                <p style={{ fontSize: '0.925rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.6 }}>
                  Modern AI answer engines need real-time data. Rather than waiting days for search bots to discover your updated sitemap, an MCP server using IndexNow (such as <Link href="/mcp/index-now-ru"><strong>index-now-ru</strong></Link> or <Link href="/mcp/seo-monster"><strong>seo-monster</strong></Link>) notifies search engine APIs within seconds of publishing.
                </p>
              </div>

              <h3>IndexNow Setup with MCP</h3>
              <ol>
                <li>Generate an IndexNow API Key (a 32-character hexadecimal string).</li>
                <li>Host the key verification file at your domain root (e.g. <code>https://example.com/&lt;apiKey&gt;.txt</code>).</li>
                <li>Pass the API key to your IndexNow MCP server.</li>
                <li>Instruct your agent to submit updated URLs immediately whenever content changes.</li>
              </ol>

              <h2 id="technical-audits">Technical SEO audits &amp; ephemeral crawling</h2>
              <p>
                Catching technical SEO regressions before they ship to production is one of the highest leverage uses of MCP inside development environments like Cursor and Windsurf. Tools like <Link href="/mcp/librecrawl-technical-seo-audit-mcp-server"><strong>librecrawl-technical-seo-audit-mcp-server</strong></Link>, <Link href="/mcp/websiteiq"><strong>websiteiq</strong></Link>, and <Link href="/mcp/pagelens-ai"><strong>pagelens-ai</strong></Link> expose headless, zero-install auditing tools directly to the model.
              </p>

              <h3>What Technical MCP Servers Check Automatically</h3>
              <ul>
                <li><strong>Status Codes &amp; Redirect Chains:</strong> Identifies 301/302 hops, 404 broken internal links, and 500 server errors across your site.</li>
                <li><strong>Robots.txt &amp; Meta Directives:</strong> Verifies that <code>noindex</code>, <code>nofollow</code>, or disallow rules do not accidentally block search engines or AI agents from indexing key content.</li>
                <li><strong>Canonical Hygiene:</strong> Flags relative vs. absolute canonical URLs, self-referencing canonicals, and duplicate title/H1 tags.</li>
                <li><strong>Schema.org JSON-LD Validation:</strong> Extracts and parses embedded JSON-LD scripts to ensure syntax compliance with Schema.org standards (such as <code>TechArticle</code>, <code>FAQPage</code>, <code>BreadcrumbList</code>, and <code>Product</code>).</li>
                <li><strong>Core Web Vitals &amp; CrUX Metrics:</strong> Integrates with Chrome User Experience (CrUX) and PageSpeed data via servers like <Link href="/mcp/seo-monster"><strong>seo-monster</strong></Link> to report real-world LCP, INP, and CLS scores.</li>
              </ul>

              <h2 id="aeo-geo-readiness">AEO &amp; GEO: Optimizing for AI answer engines</h2>
              <p>
                Search behavior has evolved. Users increasingly seek answers through <strong>Perplexity, ChatGPT Search, Claude Artifacts, Gemini, and Google AI Overviews</strong>. This discipline is known as <strong>Answer Engine Optimization (AEO)</strong> and <strong>Generative Engine Optimization (GEO)</strong>.
              </p>

              <h3>1. The <code>llms.txt</code> Standard</h3>
              <p>
                Just as <code>robots.txt</code> directs search engine crawlers, the <a href="https://llmstxt.org" target="_blank" rel="noopener noreferrer"><code>/llms.txt</code></a> specification provides clean, token-efficient markdown summaries of your website designed specifically for Large Language Models. MCP servers like <Link href="/mcp/aeo-mcp"><strong>aeo-mcp</strong></Link> and <Link href="/mcp/llmscout"><strong>llmscout</strong></Link> inspect whether your domain serves a valid <code>/llms.txt</code> and <code>/llms-full.txt</code> manifest.
              </p>
              ...
              <ul>
                <li><code>GPTBot</code> &amp; <code>OAI-SearchBot</code> (OpenAI / ChatGPT Search)</li>
                <li><code>ClaudeBot</code> (Anthropic)</li>
                <li><code>PerplexityBot</code> (Perplexity AI)</li>
                <li><code>Google-Extended</code> &amp; <code>GoogleOther</code> (Google Gemini &amp; AI training)</li>
                <li><code>Bytespider</code> &amp; <code>Applebot-Extended</code></li>
              </ul>
              ...
              <h2 id="serp-intelligence">Live SERP intelligence &amp; competitive research</h2>
              <p>
                Beyond first-party site data, agents often need real-time competitive intelligence. Servers such as <Link href="/mcp/sistrix-seo-toolbox"><strong>sistrix-seo-toolbox</strong></Link>, <Link href="/mcp/dispatchseo"><strong>dispatchseo</strong></Link>, and <Link href="/mcp/xmlriver-mcp"><strong>xmlriver-mcp</strong></Link> allow agents to query search engine result pages (SERPs) without manual scraping.
              </p>
              <ul>
                <li><strong>Featured Snippet &amp; PAA Extraction:</strong> Pulls &ldquo;People Also Ask&rdquo; questions and direct answers for target keywords to generate relevant FAQ sections.</li>
                <li><strong>Competitor Domain Visibility:</strong> Compares domain visibility indexes, keyword overlap, and backlink authority metrics across competing domains.</li>
                <li><strong>Content Gap Analysis:</strong> Identifies high-ranking topics your competitors cover that your site currently lacks.</li>
              </ul>

              <h2 id="directory-spotlight">Top SEO &amp; AEO MCP servers in the AllMCPs directory</h2>
              <p>
                Here are the most popular and verified SEO MCP servers available in the <Link href="/best/seo">AllMCPs SEO Directory</Link>:
              </p>
                  ...
                  >
                    <div>
                      ...
                      <h3 style={{ fontSize: '1.1rem', fontWeight: 700, margin: '0 0 0.5rem 0' }}>
                        <Link href={`/mcp/${server.id}`} style={{ color: 'var(--text-primary)', textDecoration: 'none' }}>
                          {server.name}
                        </Link>
                      </h3>
                      <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', lineHeight: 1.55, margin: '0 0 1rem 0' }}>
                        {server.description}
                      </p>
                    </div>
                    <div>
                      ...
                      <Link
                        ...
                        style={{ width: '100%', justifyContent: 'center', fontSize: '0.85rem', padding: '0.45rem 0.75rem' }}
                      >
              ...
              <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                <Link href="/best/seo" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Search size={16} />
                  <span>Browse All Ranked SEO &amp; Marketing MCP Servers</span>
                </Link>
              </div>

              <h2 id="config-blueprint">Complete client configuration blueprint</h2>
              <p>
              ...
              <h3>Claude Desktop Configuration (<code>claude_desktop_config.json</code>)</h3>
              <p>
                On macOS: <code>~/Library/Application Support/Claude/claude_desktop_config.json</code><br />
  ...
  "mcpServers": {
    ...
    "technical-crawler": {
      ...
      "args": ["-y", "librecrawl-mcp"]
              ...
              <h3>Cursor Configuration (<code>.cursor/mcp.json</code>)</h3>
              <CopyBlock
                language="json"
                code={`{
  "mcpServers": {
    "seo-tools": {
      ...
      "env": {
        ...
        "INDEXNOW_KEY": "\${env:INDEXNOW_API_KEY}"
              ...
              <h2 id="agent-workflows">5 ready-to-use agent SEO prompts &amp; workflows</h2>
              <p>
...
4. Verify that meta robots is set to index,follow and that no critical pages are blocked by robots.txt.`}
              ...
              <h3>3. AEO &amp; <code>llms.txt</code> Readiness Audit</h3>
              <CopyBlock
                language="text"
...
3. Compare them against our current page draft and identify missing topics, entities, and comparison tables we must add to surpass them.`}
              ...
              <h2 id="security-best-practices">Security, scopes &amp; API credential hygiene</h2>
              <p>
                Because SEO tools interact with sensitive business metrics and webmaster settings, keep these security rules in mind:
              </p>
              <ul>
                <li><strong>Use Read-Only Scopes Where Feasible:</strong> When connecting Google Search Console for analysis, configure the OAuth scope to <code>https://www.googleapis.com/auth/webmasters.readonly</code>. Reserve full write scope only for instances that manage sitemaps or submit URLs.</li>
                <li><strong>Never Commit Service Account Keys:</strong> Keep <code>credentials.json</code> and API keys in your local <code>.env</code> or system environment variables, listed in <code>.gitignore</code>.</li>
                <li><strong>Enforce Human Confirmation for Destructive Actions:</strong> If an MCP server exposes tools to delete sitemaps, modify DNS, or update robots.txt rules, configure your client to require explicit user approval before executing the tool call.</li>
                <li><strong>Respect Crawl Rate Limits:</strong> When running local site audits, set reasonable concurrency and delay limits to prevent triggering web application firewalls (WAF) or overwhelming origin servers.</li>
              </ul>
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: '16px',
                  border: '1px solid var(--border-color)',
                  background: 'linear-gradient(135deg, rgba(53, 37, 230, 0.05), rgba(34, 184, 240, 0.05))',
                }}
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--accent-color)', fontWeight: 700, fontSize: '0.875rem', marginBottom: '0.5rem' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.25rem' }}>
                  Explore verified MCP servers, configure your IDE with our free tools, or check out related development and deployment guides.
                </p>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
                  ...
                  <Link href="/tools/config-generator" className="btn btn-secondary">
