...
export async function GET(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="240" height="32" viewBox="0 0 240 32" fill="none">
    <rect width="240" height="32" rx="8" fill="#121212" />
    <rect width="240" height="32" rx="8" fill="url(#grad)" opacity="0.15" />
    <path d="M120 0h112a8 8 0 0 1 8 8v16a8 8 0 0 1-8 8h-112V0z" fill="rgba(255,255,255,0.03)"/>
    ...
    <text x="68" y="21" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif" font-size="12" font-weight="500" fill="#a1a1aa" text-anchor="middle">Featured on</text>
    <text x="175" y="22" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif" font-size="12.5" font-weight="800" letter-spacing="-0.2" fill="#ffffff" text-anchor="middle">allmcps.com</text>
    <defs>
    ...
    <rect x="0.5" y="0.5" width="239" height="31" rx="7.5" stroke="rgba(255,255,255,0.15)" />
  </svg>`;
