      ...
      <div className="site-footer-grid">
        <div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
            ...
            <a href="https://github.com/Jackalope-Dev" target="_blank" rel="noopener noreferrer" className="nav-link" aria-label="AllMCPs on GitHub" style={{ display: 'inline-flex', alignItems: 'center' }}>
