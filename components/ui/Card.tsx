...
export function Card({
  ...
  const crosshairClass = crosshair
    ? 'grid-crosshair grid-crosshair-tl grid-crosshair-br'
    : '';

  const baseClass =
    `${surfaceClass} ${hoverable || href ? 'card-hoverable' : ''} ${paddingClass} ${accentClass} ${glowClass} ${crosshairClass} ${className}`.trim();
