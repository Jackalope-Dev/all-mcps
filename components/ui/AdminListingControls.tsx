  ...
  return (
    <div
      style={{
        ...
        borderRadius: '12px',
        border: '1px solid var(--admin-bar-border)',
        ...
        <span
          style={{
            ...
            background: isPublished
              ...
              : 'rgba(239, 68, 68, 0.15)',
            color: isPublished ? 'var(--admin-ok)' : 'var(--admin-bad)',
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            background: isFeatured
              ...
              : 'var(--admin-chip-bg)',
            color: isFeatured ? 'var(--admin-warn)' : 'var(--text-secondary)',
            fontWeight: 600,
            fontSize: '0.75rem',
        ...
        <button
          ...
          style={{
            ...
            border: '1px solid var(--border-color)',
            background: 'var(--admin-chip-bg)',
            color: isPublished ? 'var(--text-secondary)' : 'var(--admin-ok)',
            fontWeight: 600,
            fontSize: '0.75rem',
