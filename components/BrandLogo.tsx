...
function BrandMark({ px }: { px: number }) {
  ...
  return (
    ...
    >
      ...
      <path d={MARK_PATH} fill={`url(#${gradId})`} fillRule="evenodd" />
    </svg>
  );
}
