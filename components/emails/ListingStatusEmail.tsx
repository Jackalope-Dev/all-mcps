  ...
  return (
    ...
    >
      ...
      {isApproved ? (
        <>
          <Text style={textStyle}>
            Great news — your MCP server is live on the AllMCPs directory. Developers can
            discover and install it now:
          </Text>
          ...
          <Text style={{ ...textStyle, marginTop: "28px" }}>
            <strong style={{ color: "#e2e8f0" }}>Free SEO boost: dofollow backlink</strong>
          </Text>
          <Text style={textStyle}>
            You can earn a <strong style={{ color: "#34d399" }}>dofollow</strong> website
          ...
          <Text style={textStyle}>
            ...
            <br />
            3. Place the AllMCPs badge on that site{" "}
            <em>without</em> a <code style={codeStyle}>nofollow</code> attribute
          </Text>
          <Text style={textStyle}>
            We recheck the badge periodically so it stays honest. Premium listings get
            dofollow instantly (no badge required).
          </Text>
          <Button href={claimUrl} style={{ ...buttonStyle, backgroundColor: "#0e7490" }}>
            Claim listing &amp; get free dofollow link
          </Button>
          <Text style={{ ...textStyle, fontSize: "13px", color: "#94a3b8" }}>
            After claiming you can also edit details, upload a logo, and manage the listing
            from your{" "}
        ...
        <>
          <Text style={textStyle}>
            We cannot approve your listing in its current state. Please review the feedback
