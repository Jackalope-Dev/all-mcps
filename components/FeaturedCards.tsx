    ...
    <section className="container animate-fade-in delay-2" style={{ marginBottom: '2.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '1.5rem' }}>
        {displayServers.map((server) => (
          ...
          <Card href={`/mcp/${server.id}`} hoverable glow crosshair className="directory-card-featured" style={{ padding: 'clamp(1.25rem, 4vw, 2rem)', paddingBottom: '12px', display: 'flex', flexDirection: 'column', minHeight: '310px', maxHeight: '310px', position: 'relative', overflow: 'hidden' }}>
