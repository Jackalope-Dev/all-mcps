...
const MICRO_LAUNCH_DIRECTORIES = [
  {
    ...
    category: 'Micro Launch & Backlink',
  },
  {
    name: 'MicroLaunch',
  ...
  {
    name: 'LaunchDock',
    url: 'https://launchdock.cloud/',
    category: 'Micro Launch',
  },
  {
    name: 'AeroLaunch',
    url: 'https://aerolaunch.app/',
    category: 'App Launch',
  },
  {
    name: 'Dang.ai',
  ...
  },
  {
    ...
    url: 'https://tooldirectory.ai/submit-tool',
    category: 'AI Tools',
  },
  {
    name: 'SaaS AI Tools',
  ...
  {
    name: 'AI Top Tools',
    url: 'https://aitoptools.com/submit-a-tool/',
    category: 'AI Directory',
  },
  {
  ...
  {
    name: 'AIAI.Tools',
    url: 'https://aiai.tools/submit-ai-tool',
    category: 'AI Tools',
  },
  {
    name: 'Cloud Findr',
  ...
  {
    name: 'Five Taco',
    url: 'https://fivetaco.com',
    category: 'Software Tools',
  },
  {
    name: 'AI ToolBoard',
    url: 'https://aitoolboard.com/submit-ai-tool',
    category: 'AI Tools',
  },
  ...
  {
    name: 'Openfuture',
    url: 'https://openfuture.ai/submit-tool',
    category: 'AI Tools',
  },
  {
    name: 'MarsX',
  ...
  {
    name: 'The AI Navigator',
    url: 'https://www.theainavigator.com/submit-an-ai-tool',
    category: 'AI Tools',
  },
  {
    name: 'StartupBase',
  ...
  {
    name: 'AI Hub',
    url: 'https://aihub.org/contribute/',
  ...
  {
    name: 'PoweredbyAI',
    url: 'https://poweredbyai.app/submit-tool',
    category: 'AI Tools',
  },
  ...
  {
    name: 'AI of The Day',
    url: 'https://aioftheday.com/submit-a-tool',
    category: 'AI Tools',
  },
  {
    name: 'Canopy Directory',
    url: 'https://www.canopydirectory.com/suggest-tool',
    category: 'Tools',
  },
  {
    name: 'Mr. Free Tools',
  ...
  {
    name: 'AI Tool Guru',
    url: 'https://aitoolguru.com/submit-ai-tool',
    category: 'AI Tools',
  },
...
console.log(
  `Setting up ${MICRO_LAUNCH_DIRECTORIES.length} Micro Launch & Tool Backlink platforms...`,
);
...
console.log(
  `Successfully saved ${MICRO_LAUNCH_DIRECTORIES.length} micro launch & tool directories to ${jsonPath}!`,
);
