...
const CATEGORY_RULES = [
  ...
  },
  {
    ...
    regex: /\b(slack|discord|telegram|whatsapp|email|gmail|sendgrid|resend|mailchimp|matrix|teams|twilio|zendesk|intercom|messaging|messenger|outlook|webhook|notification)\b/i,
  },
  {
    category: '📂 Browser Automation',
    regex: /\b(playwright|puppeteer|selenium|browserbase|stagehand|headful|headless-browser|browser-automation|chromedp|web-browser|browser-use|simulator|ios-simulator)\b/i,
  },
  {
    category: '🔎 Search & Data Extraction',
    regex: /\b(serper|tavily|brave-search|google-search|bing-search|duckduckgo|web-scraper|scraping|crawling|web-crawler|firecrawl|jina-ai|diffbot|web-extraction|web-search|code-search|search-engine)\b/i,
  },
  {
    category: '🔄 Version Control',
    regex: /\b(github-api|github-issues|github-pulls|gitlab|bitbucket|gitea|git-repo|git-commit|version-control|subversion|mercurial|git-history|commits)\b/i,
  },
  {
    category: '☁️ Cloud Platforms',
    regex: /\b(aws|amazon-web-services|gcp|google-cloud|azure|cloudflare|terraform|kubernetes|k8s|docker|vercel|netlify|digitalocean|heroku|cloud-infrastructure|aws-lambda|s3-bucket|jenkins|bitrise|buildkite|cicd|ci-cd|pipeline-automation|apisix|envoy|traefik|nginx|gateway)\b/i,
  },
  {
    category: '📊 Monitoring',
    regex: /\b(sentry|datadog|prometheus|grafana|opentelemetry|logrocket|newrelic|pagerduty|uptime|logging|observability|metrics|alerting|statuspage|telemetry|code-quality|linter)\b/i,
  },
  {
    category: '🏢 Workplace & Productivity',
    regex: /\b(jira|linear|trello|asana|notion|clickup|confluence|google-calendar|google-docs|todoist|airtable|workplace|google-sheets|excel|task-management)\b/i,
  },
  {
    category: '📋 Product Management',
    regex: /\b(codebeamer|alm|product-management|work-items|trackers|feature-flags|product-board)\b/i,
  },
  {
    category: '💰 Finance & Fintech',
    regex: /\b(stripe|shopify|plaid|crypto|solana|ethereum|bitcoin|base-chain|x402|stock-market|finance|financial|accounting|hledger|forex|sec-edgar|wallet|token|defi|fintech|sepa|exchange-rate|payment|payroll|billing|invoice)\b/i,
  },
  {
    category: '🧠 Knowledge & Memory',
    regex: /\b(pinecone|weaviate|qdrant|chroma|vector-db|vector-database|rag|memory|knowledge-base|obsidian|roam|logseq|mem0|zotero|notes|note-taking|embeddings|context-engineering|knowledge-graph)\b/i,
  },
  {
    category: '🔒 Security',
    regex: /\b(security-scan|vulnerability|vulnerabilities|secrets|vault|snyk|sonar|auth0|okta|pentest|penetration|cve|threat-analysis|cybersecurity|auth-type|soc-security|threat|slop-detector|audit)\b/i,
  },
  {
  ...
  },
  {
    ...
    regex: /\b(ffmpeg|video-processing|video-editing|image-processing|opencv|sharp|yt-dlp|youtube-dl|audio-processing|media-processing|image-audit|image-dimension)\b/i,
  },
  {
  ...
  },
  {
    ...
    regex: /\b(code-execution|python-interpreter|repl|sandbox|e2b|run-code|swift-compiler|code-runner)\b/i,
  },
  {
    category: '📂 File Systems',
    regex: /\b(filesystem|file-system|local-files|directory-tree|file-search|google-drive|dropbox|onedrive|filescope)\b/i,
  },
  {
    category: '🤖 Coding Agents',
    regex: /\b(coding-agent|claude-code|skill-ninja|agent-skill|aide-spec|code-intelligence|hierarchical-code)\b/i,
  },
  {
    category: '📊 Data Visualization',
    regex: /\b(mermaid|diagrams|mindmap|charting|graph-visualization|mindpilot)\b/i,
  },
  {
    category: '🔗 Aggregators',
    regex: /\b(openapi-to-mcp|swagger-to-mcp|rest-api-wrapper|mcp-link|api-connector)\b/i,
  },
  {
    category: '🎓 Education',
    regex: /\b(python-docs|cheatsheet|documentation-retrieval|reference-docs)\b/i,
  },
];
