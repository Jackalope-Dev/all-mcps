...
(() => {
  ...
  inputs.forEach((input) => {
    ...
    if (
      matchStr.includes('title') ||
      matchStr.includes('product') ||
      matchStr.includes('app_name') ||
      matchStr.includes('startup') ||
      matchStr.includes('name')
    ) {
      if (!input.value) {
      ...
      matchStr.includes('url') ||
      matchStr.includes('link') ||
      matchStr.includes('website') ||
      matchStr.includes('domain')
    ) {
      if (!input.value) {
      ...
      matchStr.includes('tagline') ||
      matchStr.includes('headline') ||
      matchStr.includes('summary') ||
      matchStr.includes('one_liner') ||
      matchStr.includes('pitch')
    ) {
      if (!input.value) {
      ...
      matchStr.includes('desc') ||
      matchStr.includes('detail') ||
      matchStr.includes('about') ||
      matchStr.includes('bio')
    ) {
      if (!input.value) {
        input.value = data.longDescription;
        filledCount++;
      }
