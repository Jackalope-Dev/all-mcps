...
const checks = [
  ...
  {
    name: 'API Catalog route',
    path: 'app/api/well-known/api-catalog/route.ts',
  },
  {
    name: 'OpenID configuration route',
    path: 'app/api/well-known/openid-configuration/route.ts',
  },
  {
    name: 'OAuth Protected Resource route',
    path: 'app/api/well-known/oauth-protected-resource/route.ts',
  },
  {
    name: 'MCP Server Card route',
    path: 'app/api/well-known/mcp-server-card/route.ts',
  },
  {
    name: 'Agent Skills Index route',
    path: 'app/api/well-known/agent-skills/index/route.ts',
  },
  { name: 'Auth.md route', path: 'app/api/well-known/auth-md/route.ts' },
  { name: 'Health check route', path: 'app/api/v1/health/route.ts' },
  {
    name: 'Markdown renderer route',
    path: 'app/api/v1/markdown-renderer/route.ts',
  },
  ...
  {
    name: 'Public mcp-search SKILL.md',
    path: 'public/.well-known/agent-skills/mcp-search/SKILL.md',
  },
  {
    name: 'Public mcp-registry SKILL.md',
    path: 'public/.well-known/agent-skills/mcp-registry/SKILL.md',
  },
];
