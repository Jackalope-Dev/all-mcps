...
async function generatePreviews() {
  ...
  const magicLinkHtml = await render(<MagicLinkEmail loginUrl="https://allmcps.com/login?token=test" />);
  ...
  const notificationHtml = await render(<NotificationEmail heading="Alert" message="System maintenance tonight" />);
